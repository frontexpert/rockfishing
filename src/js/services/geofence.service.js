rockFishing.services.factory('GeofenceService', function ($q, $log, $rootScope, $window, $ionicLoading) {
    var geofenceService = {
        _geofences: [],
        ...
        create: function (attributes) {
            var defaultGeofence = {
                ...
                notification: {
                    ...
                    text: "Please update your location or check out.",
        ...
        saveGeofenceCacheToLocalStorage: function (geofence) {
            localStorage["geofenceCache"] = angular.toJson(geofence);
        },

        activateGeofenceFromCache: function () {
            var self = this;
            var result = localStorage["geofenceCache"];
            var geofence = angular.fromJson(result);
            self.addOrUpdate(geofence);
        }
    };
